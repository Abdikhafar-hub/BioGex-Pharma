  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[300px] max-w-full relative rounded-lg shadow-md flex-shrink-0 px-4 py-3 md:w-[350px] "
            style={{
              background:
                "white",
            }}
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-sm leading-[1.6] text-gray-700 font-normal max-w-xxs">
                {item.quote}
              </span>
